...
int Safe_Line_X(double Dxs, double Dys, double Dxe, double Dye)
{
  ...
  if ((ixs >= 0) && (ixs < Xx_Pix_width) && (ixe >= 0) && (ixe < Xx_Pix_width) && (iys >= 0) && (iys < Xx_Pix_height) && (iye >= 0) && (iye < Xx_Pix_height))
  {
...
int Horizontal_Single_Pixel_Line_X(double Dx0, double Dx1, double Dy)
{
  ...
  if (x0 < 0)
    x0 = 0; // this makes x0 STILL less than or equal to x1 because of above.
  if (x1 >= Xx_Pix_width)
    x1 = Xx_Pix_width - 1; // still guarantees x0 <= x1
...
static unsigned char bmp_header[54] = {
    ...
    0x00,
    0x00,
    0x00, // size of bmp file-overwrite
    0x00,
    0x00,
    0x00,
    0x00,
    ...
    0x00,
    0x00,
    0x00, // width of bitmap in pixels-overwrite
    0x00,
    0x00,
    0x00,
    0x00, // height of bitmap in pixles-overwrite
    0x01,
    0x00,
    0x18,
    0x00,
    ...
    0x00,
    0x00,
    0x00, // size of raw bmp data after this bmp_header
    0x13,
    0x0B,
    0x00,
    0x00,
